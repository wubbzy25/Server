...
exports.UsersModule = UsersModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([user_entities_1.User, categories_entities_1.Category, subitem_entities_1.SubItem, fields_entities_1.Fields]),
        ],
        providers: [users_service_1.UsersService, code_access_token_services_1.CodeGeneratorAccessTokenService],
