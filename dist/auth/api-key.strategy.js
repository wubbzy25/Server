...
let ApiKeyStrategy = exports.ApiKeyStrategy = class ApiKeyStrategy extends (0, passport_1.PassportStrategy)(passport_headerapikey_1.HeaderAPIKeyStrategy) {
    constructor(authService) {
        super({
            header: 'AccessToken',
            prefix: '',
        }, true, (AccessToken, done) => {
